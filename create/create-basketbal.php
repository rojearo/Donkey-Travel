...
<html lang="en">
  <head>
    ...
    <title>Sport toevoegen</title>
</head>
<body>
    <div class="container">
      <div class="row">
        <div class="col-md-12 mt-5">
          <h1 class="text-center">Voeg een sport toe!</h1>
          ...
          ?>
           <form action="" method="post">
            <div class="form-group">
              ...
              <input type="text" name="speltype" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" name="maxpersoon" class="form-control">
            </div>
            <div class="form-group">
              <label for="">Opmerking</label>
              <textarea name="opmerking" id="" cols="" rows="3" class="form-control"></textarea>
            </div>
            <div class="form-group">
